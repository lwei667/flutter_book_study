...
class FilePathDemoPage extends BasePage {
  FilePathDemoPage({
    super.key,
    super.titleName,
    super.route,
  ...
  @override
  State<FilePathDemoPage> createState() => _FilePathDemoPageState();
}

class _FilePathDemoPageState extends BasePageState<FilePathDemoPage> {
